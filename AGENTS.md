2026-09-18 MVP阶段检查点：五角色新版模拟整局145调查/205刷新通过；T真实终局与封卷8OK并结算，但公开来源3/4、私卷4份均未整份有源通过，finale1.4/table1.2候选未启用。后端3224、脱敏定向41、前端114、类型/lint/构建/预检14及独立复核通过。语音单独接回3017/API8017，运行仍topic v4/finale1.2/table1.1，前端GOg_ZIZaWQrchzLZGl6h1；30秒初始化超时释放已实际验证，桌面/390px入口正常，已请用户真实麦克风测试。原7表40局/43开场/1397事件、133旧账本、13冻结输入及3语音回执保持。阶段12次/¥0.292026，M4累计155次/¥2.49883624（原200次/¥10），语音新调用0。PRD0.35。新增用户授权按阶段同步w93139/AI-Script-Game；下一步逐项证据/事件与未知信息约束、固定有源场景，再补五角色真实矩阵，MVP未验收。详见[本阶段证据](docs/development/M4_FINALE_MVP.md)。
