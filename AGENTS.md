2026-09-19 M4终局证据候选：公开1.5/table1.3/binding1.5新增逐选项来源、未知及服务端私有核验；旧版本/192输出上限/旧请求保持。后端3313、预检14、独立89项通过；五角模拟145调查/205刷新/结算、40旧视图一致。T真实8次公开2OK/2INVALID、私卷4OK并结算，但来源质量仍未全过，候选未启用。原7表40局/43开场/1397事件、169旧账本、13冻结输入保持。新增8次/¥0.377234，M4累计163次/¥2.87607024，原200次/¥10不变；语音新调用0。运行仍3017/API8017、topic v4/finale1.2/table1.1及前端GOg_ZIZaWQrchzLZGl6h1，用户稍后测麦克风。PRD0.36。下一步补私卷已获调查地点映射、修引用错位与推断；不能修改已发1.5/1.3提示或回执。仍M4，总验收未过；见[本阶段记录](docs/development/M4_FINALE_EVIDENCE.md)。
